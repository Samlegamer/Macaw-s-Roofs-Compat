...
public class MRBOPBlocksRegistry
{
    ...
    public static RegistryObject<Block> roof, attic_roof, top_roof, lower_roof, steep_roof, upper_lower_roof, upper_steep_roof;
    public static RegistryObject<Block> planks_roof, planks_attic_roof, planks_top_roof, planks_lower_roof, planks_steep_roof, planks_upper_lower_roof, planks_upper_steep_roof;

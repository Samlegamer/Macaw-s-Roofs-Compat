...
public class MacawsRoofsBOP
{
	...
	private void ClientSetup(FMLClientSetupEvent event)
	{
       ...
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.cherry_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.cherry_planks_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.dead_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.dead_planks_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.fir_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.fir_planks_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.hellbark_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.hellbark_planks_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.jacaranda_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.jacaranda_planks_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.magic_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.magic_planks_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.mahogany_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.mahogany_planks_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.palm_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.palm_planks_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.redwood_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.redwood_planks_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.umbran_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.umbran_planks_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.willow_upper_steep_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.willow_planks_upper_steep_roof.get(), RenderType.cutoutMipped());

       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.cherry_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.cherry_planks_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.dead_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.dead_planks_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.fir_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.fir_planks_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.hellbark_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.hellbark_planks_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.jacaranda_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.jacaranda_planks_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.magic_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.magic_planks_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.mahogany_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.mahogany_planks_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.palm_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.palm_planks_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.redwood_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.redwood_planks_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.umbran_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.umbran_planks_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.willow_upper_lower_roof.get(), RenderType.cutoutMipped());
       RenderTypeLookup.setRenderLayer(MRBOPBlocksRegistry.willow_planks_upper_lower_roof.get(), RenderType.cutoutMipped());
	}
	...
	private void depedencies(BiomesOPlenty bop, MacawsRoofs mcwroofs) {}
}
...
public class MRBOPBlocksRegistry
{
	...
	public static final Block empyreal_roof = new BaseRoof(Blocks.OAK_PLANKS.getDefaultState(), AbstractBlock.Settings.create().strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD));

	public static final Block empyreal_attic_roof = new RoofGlass(AbstractBlock.Settings.create().strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD));

	public static final Block empyreal_top_roof = new RoofTopNew(AbstractBlock.Settings.create().strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD));

	public static final Block empyreal_lower_roof = new BaseRoof(Blocks.OAK_PLANKS.getDefaultState(), AbstractBlock.Settings.create().strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD));

	public static final Block empyreal_steep_roof = new SteepRoof(Blocks.OAK_PLANKS.getDefaultState(), AbstractBlock.Settings.create().strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD));

	public static final Block empyreal_upper_lower_roof = new Lower(Blocks.OAK_PLANKS.getDefaultState(), AbstractBlock.Settings.create().strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD));

	public static final Block empyreal_upper_steep_roof = new Steep(Blocks.OAK_PLANKS.getDefaultState(), AbstractBlock.Settings.create().strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD));

	public static final Block empyreal_planks_roof = new BaseRoof(Blocks.OAK_PLANKS.getDefaultState(), AbstractBlock.Settings.create().strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD));

	public static final Block empyreal_planks_attic_roof = new RoofGlass(AbstractBlock.Settings.create().strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD));

	public static final Block empyreal_planks_top_roof = new RoofTopNew(AbstractBlock.Settings.create().strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD));

	public static final Block empyreal_planks_lower_roof = new BaseRoof(Blocks.OAK_PLANKS.getDefaultState(), AbstractBlock.Settings.create().strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD));

	public static final Block empyreal_planks_steep_roof = new SteepRoof(Blocks.OAK_PLANKS.getDefaultState(), AbstractBlock.Settings.create().strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD));

	public static final Block empyreal_planks_upper_lower_roof = new Lower(Blocks.OAK_PLANKS.getDefaultState(), AbstractBlock.Settings.create().strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD));

	public static final Block empyreal_planks_upper_steep_roof = new Steep(Blocks.OAK_PLANKS.getDefaultState(), AbstractBlock.Settings.create().strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD));
    ...
    {
    	Registry.register(Registries.BLOCK, Identifier.of(MacawsRoofsBOP.MODID, name), b);
    	blockItem(b, name);
	}
    
    private static void blockItem(Block b, String n)
    {
        Registry.register(Registries.ITEM, Identifier.of(MacawsRoofsBOP.MODID, n), new BlockItem(b, new Item.Settings()));
    }

package fr.samlegamer.netherupdate.code;
...
public class MacawsBridgesCode
{
	...
	public static void InitAllRenderType(String Location, ArrayList<String> Material, String ClassMod)
	{
		RenderType.BridgeLog(Location, Material, ClassMod);
		RenderType.BridgeRail(Location, Material, ClassMod);
		RenderType.BridgeStairsLog(Location, Material, ClassMod);
		RenderType.PierBridgeWood(Location, Material, ClassMod);
		RenderType.RopeBridge(Location, Material, ClassMod);
	}
